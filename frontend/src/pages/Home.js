                ...
                <div className="md:flex w-full h-full">
                    ...
                    <div className="w-full md:w-1/2 py-10 px-8 h-full flex flex-col justify-center">
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <div>
                                <label className="font-mono block text-sm font-semibold mb-1" htmlFor="provider">
                                    Provider
                                </label>
                                <input
                                    id="provider"
                                    ...
                                    value="Geotab"
                                    readOnly
                                    className="font-mono block w-full border border-gray-600 rounded-md px-3 py-2 bg-gray-200 text-black cursor-not-allowed"
                                />
                            </div>
                            <div>
                                <label className="block text-sm font-semibold mb-1 font-mono" htmlFor="serialNumber">
                                ...
                                <input
                                    ...
                                    className="w-full border border-gray-600 rounded-md px-3 py-2 focus:outline-none focus:border-blue-500 bg-white text-black"
                                />
                            </div>
                            <div>
                                <label className="font-mono block text-sm font-semibold mb-1" htmlFor="location">
                        ...
                        <Link to={"/Dashboard"} className="font-mono block text-xs font-semibold text-blue-400 mt-4">Return to Dashboard.</Link>
