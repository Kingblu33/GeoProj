        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-900 text-black">
                <div className="bg-dark-100 rounded-lg shadow-lg p-10 w-full max-w-md border border-black bg-white">
                    ...
                    <Link to="/Home" className="font-mono bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-full block w-full text-center">Back to Home</Link>
                </div>
            </div>
        );
    }
        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-gray-900">
            <div className="flex space-x-6">
                <div className="p-10 rounded-3xl bg-white max-w-md w-full flex flex-col">
                    ...
                    <div className="mt-4 flex-grow">
                        <div className="font-mono p-4 text-black">
                            <div className="flex justify-between mb-4">
                                ...
                                <span className="font-semibold" style={{ color: data.status === 'Reporting' ? 'green' : 'red' }}>{data.status}</span>
                            </div>
                            <div className="flex justify-between mb-4">
                    ...
                    <Link to="/Home" className="mt-6 font-mono bg-blue-900 hover:bg-blue-800 text-white font-semibold py-2 px-4 rounded-full block w-full text-center">Return to Device Check</Link>
                </div>

                {data.status !== 'eporting' &&(
                    <div className="p-10 rounded-3xl bg-white max-w-md w-full flex flex-col">
                        <h3 className="font-medium text-xl tracking-tight text-gray-900 leading-tight mb-4">Tool Tips</h3>
                        <p className="text-md font-normal text-gray-400 leading-none mb-2">The device is currently not reporting here are some general tool tips.</p>
                        ...
                        <Link to="/help" className="mt-6 font-mono bg-blue-900 hover:bg-blue-800 text-white font-semibold py-2 px-4 rounded-full block w-full text-center">View Detailed Documentation</Link>
                    </div>
                )}
            </div>
        </div>
