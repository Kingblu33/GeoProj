            ...
            <div className="bg-gray-black text-gray-500 rounded-3xl w-full md:max-w-6xl h-full">
                <div className="flex flex-col w-full h-full py-10 px-8 space-y-6">
                    ...
                    <p className="text-lg text-center text-white">
                        Select a device below to check its status, access detailed
                        instructions, or place an order. 
                    </p>

                    {items.map((item, index) => (
                        <div
                            key={index}
                            className="flex flex-col items-start rounded-lg shadow-lg p-6 relative transition-transform transform hover:scale-95 mb-6"
                            style={{
